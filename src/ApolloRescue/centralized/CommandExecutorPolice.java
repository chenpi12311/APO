    ...
    public CommandExecutorPolice(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
        ...
        switch  (scenarioInfo.getMode()) {
            case PRECOMPUTATION_PHASE:
                this.pathPlanning = moduleManager.getModule("CommandExecutorPolice.PathPlanning", "ApolloRescue.module.algorithm.ApolloPathPlanning");
                this.actionExtClear = moduleManager.getExtAction("CommandExecutorPolice.ActionExtClear", "ApolloRescue.extaction.ActionExtClear");
                this.actionExtMove = moduleManager.getExtAction("CommandExecutorPolice.ActionExtMove", "ApolloRescue.extaction.ActionExtMove");
                break;
            case PRECOMPUTED:
                this.pathPlanning = moduleManager.getModule("CommandExecutorPolice.PathPlanning", "ApolloRescue.module.algorithm.ApolloPathPlanning");
                this.actionExtClear = moduleManager.getExtAction("CommandExecutorPolice.ActionExtClear", "ApolloRescue.extaction.ActionExtClear");
