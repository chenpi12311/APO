package ApolloRescue.centralized;
...
public class CommandExecutorFire extends CommandExecutor<CommandFire> {
    ...
    public CommandExecutorFire(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
        ...
        switch  (si.getMode()) {
            case PRECOMPUTATION_PHASE:
                this.pathPlanning = moduleManager.getModule("CommandExecutorFire.PathPlanning", "ApolloRescue.module.algorithm.ApolloPathPlanning");
                this.actionFireFighting = moduleManager.getExtAction("CommandExecutorFire.ActionFireFighting", "ApolloRescue.extaction.ActionFireFighting");
                this.actionExtMove = moduleManager.getExtAction("CommandExecutorFire.ActionExtMove", "ApolloRescue.extaction.ActionExtMove");
                break;
            case PRECOMPUTED:
                this.pathPlanning = moduleManager.getModule("CommandExecutorFire.PathPlanning", "ApolloRescue.module.algorithm.ApolloPathPlanning");
                this.actionFireFighting = moduleManager.getExtAction("CommandExecutorFire.ActionFireFighting", "ApolloRescue.extaction.ActionFireFighting");
    ...
    public CommandExecutor calc() {
        this.result = null;
//      this.setLocationHistory(agentInfo, worldInfo);
//      System.out.println("location history list size == " + this.locations.size());
