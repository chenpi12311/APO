...
public class ApolloDecentralizedPoliceTargetAllocator extends PoliceTargetAllocator
{
    public ApolloDecentralizedPoliceTargetAllocator(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData)
    {
