...
public class ApolloDecentralizedAmbulanceTargetAllocator extends AmbulanceTargetAllocator {
    public ApolloDecentralizedAmbulanceTargetAllocator(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
