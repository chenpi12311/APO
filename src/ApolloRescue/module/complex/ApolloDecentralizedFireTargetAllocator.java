...
public class ApolloDecentralizedFireTargetAllocator extends FireTargetAllocator
{
    public ApolloDecentralizedFireTargetAllocator(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData)
    {
