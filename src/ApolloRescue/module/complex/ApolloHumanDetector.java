...
public class ApolloHumanDetector extends HumanDetector
{
    ...
    public ApolloHumanDetector(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData)
    {
        ...
        switch (scenarioInfo.getMode())
        {
            case PRECOMPUTATION_PHASE:
                this.clustering = moduleManager.getModule("ApolloHumanDetector.Clustering", "ApolloRescue.module.algorithm.ApolloKMeans");
                break;
            case PRECOMPUTED:
                this.clustering = moduleManager.getModule("ApolloHumanDetector.Clustering", "ApolloRescue.module.algorithm.ApolloKMeans");
                break;
    ...
    public HumanDetector updateInfo(MessageManager messageManager)
    {
        ...
        System.out.println(agentInfo.getTime());
    ...
    public HumanDetector calc()
    {
        ...
        private EntityID calcTargetInClusterWithOutEntity(StandardEntity result)
        {
