...
import ApolloRescue.tactics.utils.MessageTool;
...
public class ApolloTacticsFireBrigade extends TacticsFireBrigade
{
    ...
    public void initialize(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, MessageManager messageManager, DevelopData developData)
    {
        ...
        switch  (scenarioInfo.getMode())
        {
            ...
            case PRECOMPUTED:
                this.search = moduleManager.getModule("TacticsFireBrigade.Search", "ApolloRescue.module.complex.ApolloSearch");
                this.buildingDetector = moduleManager.getModule("TacticsFireBrigade.BuildingDetector", "ApolloRescue.module.complex.ApolloBuildingDetector");
                this.actionFireFighting = moduleManager.getExtAction("TacticsFireBrigade.ActionFireFighting", "ApolloRescue.extaction.ActionFireFighting");
                this.actionExtMove = moduleManager.getExtAction("TacticsFireBrigade.ActionExtMove", "ApolloRescue.extaction.ActionExtMove");
                this.commandExecutorFire = moduleManager.getCommandExecutor("TacticsFireBrigade.CommandExecutorFire", "ApolloRescue.centralized.CommandExecutorFire");
                this.commandExecutorScout = moduleManager.getCommandExecutor("TacticsFireBrigade.CommandExecutorScout", "ApolloRescue.centralized.CommandExecutorScout");
                break;
            case NON_PRECOMPUTE:
                this.search = moduleManager.getModule("TacticsFireBrigade.Search", "ApolloRescue.module.complex.ApolloSearch");
                this.buildingDetector = moduleManager.getModule("TacticsFireBrigade.BuildingDetector", "ApolloRescue.module.complex.ApolloBuildingDetector");
    ...
    public Action think(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, MessageManager messageManager, DevelopData developData)
    {
        ...
        {
        	PathPlanning pathPlanning = (PathPlanning)moduleManager.getModule("ActionFireFighting.PathPlanning", "ApolloRescue.module.algorithm.ApolloPathPlanning");
