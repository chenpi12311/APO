...
//import adf.agent.utils.WorldViewer;
...
public class ApolloTacticsPoliceForce extends TacticsPoliceForce
{
    ...
    public void initialize(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, MessageManager messageManager, DevelopData developData)
    {
        ...
        switch  (scenarioInfo.getMode())
        {
            ...
            case PRECOMPUTED:
                this.search = moduleManager.getModule("TacticsPoliceForce.Search", "ApolloRescue.module.complex.ApolloSearch");
                this.roadDetector = moduleManager.getModule("TacticsPoliceForce.RoadDetector", "ApolloRescue.module.complex.ApolloRoadDetector");
                this.actionExtClear = moduleManager.getExtAction("TacticsPoliceForce.ActionExtClear", "ApolloRescue.extaction.ActionExtClear");
                this.actionExtMove = moduleManager.getExtAction("TacticsPoliceForce.ActionExtMove", "ApolloRescue.extaction.ActionExtMove");
                this.commandExecutorPolice = moduleManager.getCommandExecutor("TacticsPoliceForce.CommandExecutorPolice", "ApolloRescue.centralized.CommandExecutorPolice");
                this.commandExecutorScout = moduleManager.getCommandExecutor("TacticsPoliceForce.CommandExecutorScout", "ApolloRescue.centralized.CommandExecutorScoutPolice");
                break;
            case NON_PRECOMPUTE:
                this.search = moduleManager.getModule("TacticsPoliceForce.Search", "ApolloRescue.module.complex.ApolloSearch");
                this.roadDetector = moduleManager.getModule("TacticsPoliceForce.RoadDetector", "ApolloRescue.module.complex.ApolloRoadDetector");
