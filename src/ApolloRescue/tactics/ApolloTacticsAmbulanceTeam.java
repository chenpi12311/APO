...
public class ApolloTacticsAmbulanceTeam extends TacticsAmbulanceTeam
{
    ...
    public void initialize(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, MessageManager messageManager, DevelopData developData)
    {
        ...
        switch (scenarioInfo.getMode())
        {
            ...
            case PRECOMPUTED:
                this.humanDetector = moduleManager.getModule("TacticsAmbulanceTeam.HumanDetector", "ApolloRescue.module.complex.ApolloHumanDetector");
                this.search = moduleManager.getModule("TacticsAmbulanceTeam.Search", "ApolloRescue.module.complex.ApolloSearch");
                this.actionTransport = moduleManager.getExtAction("TacticsAmbulanceTeam.ActionTransport", "ApolloRescue.extaction.ActionTransport");
                this.actionExtMove = moduleManager.getExtAction("TacticsAmbulanceTeam.ActionExtMove", "ApolloRescue.extaction.ActionExtMove");
                this.commandExecutorAmbulance = moduleManager.getCommandExecutor("TacticsAmbulanceTeam.CommandExecutorAmbulance", "ApolloRescue.centralized.CommandExecutorAmbulance");
                this.commandExecutorScout = moduleManager.getCommandExecutor("TacticsAmbulanceTeam.CommandExecutorScout", "ApolloRescue.centralized.CommandExecutorScout");
                break;
            case NON_PRECOMPUTE:
                this.humanDetector = moduleManager.getModule("TacticsAmbulanceTeam.HumanDetector", "ApolloRescue.module.complex.ApolloHumanDetector");
                this.search = moduleManager.getModule("TacticsAmbulanceTeam.Search", "ApolloRescue.module.complex.ApolloSearch");
