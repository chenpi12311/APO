...
public class ApolloTacticsFireStation extends TacticsFireStation
{
        ...
        switch (scenarioInfo.getMode())
        {
            ...
            case PRECOMPUTED:
                this.allocator = moduleManager.getModule(
                        ...
                        "ApolloRescue.module.complex.ApolloFireTargetAllocator");
                this.picker = moduleManager.getCommandPicker(
                        "TacticsFireStation.CommandPicker",
                        "ApolloRescue.centralized.CommandPickerFire");
                break;
            case NON_PRECOMPUTE:
                this.allocator = moduleManager.getModule(
                        "TacticsFireStation.TargetAllocator",
