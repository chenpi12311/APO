...
public class ApolloTacticsAmbulanceCentre extends TacticsAmbulanceCentre
{
        ...
        switch (scenarioInfo.getMode())
        {
            ...
            case PRECOMPUTED:
                this.allocator = moduleManager.getModule(
                        ...
                        "ApolloRescue.module.complex.ApolloAmbulanceTargetAllocator");
                this.picker = moduleManager.getCommandPicker(
                        "TacticsAmbulanceCentre.CommandPicker",
                        "ApolloRescue.centralized.CommandPickerAmbulance");
                break;
            case NON_PRECOMPUTE:
                this.allocator = moduleManager.getModule(
                        "TacticsAmbulanceCentre.TargetAllocator",
