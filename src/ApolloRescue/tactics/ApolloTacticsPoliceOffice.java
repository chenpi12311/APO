...
public class ApolloTacticsPoliceOffice extends TacticsPoliceOffice
{
        ...
        switch  (scenarioInfo.getMode())
        {
            ...
            case PRECOMPUTED:
                this.allocator = moduleManager.getModule(
                        ...
                        "ApolloRescue.module.complex.ApolloPoliceTargetAllocator");
                this.picker = moduleManager.getCommandPicker(
                        "TacticsPoliceOffice.CommandPicker",
                        "ApolloRescue.centralized.CommandPickerPolice");
                break;
            case NON_PRECOMPUTE:
                this.allocator = moduleManager.getModule(
                        "TacticsPoliceOffice.TargetAllocator",
