package ApolloRescue.tactics.utils;
...
public class MessageTool
{
    ...
    public MessageTool(ScenarioInfo scenarioInfo, DevelopData developData)
    {
        ...
        this.sendingAvoidTimeReceived = developData.getInteger("Apollo.tactics.MessageTool.sendingAvoidTimeReceived", 3);
        this.sendingAvoidTimeSent = developData.getInteger("Apollo.tactics.MessageTool.sendingAvoidTimeSent", 5);
        this.sendingAvoidTimeClearRequest = developData.getInteger("Apollo.tactics.MessageTool.sendingAvoidTimeClearRequest", 5);
        this.estimatedMoveDistance = developData.getInteger("Apollo.tactics.MessageTool.estimatedMoveDistance", 40000);
