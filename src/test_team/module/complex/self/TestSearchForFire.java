...
public class TestSearchForFire extends Search {
	...
	public TestSearchForFire(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
		...
		if (agentURN == AMBULANCE_TEAM) {
			this.pathPlanning = moduleManager.getModule("TestSearch.PathPlanning.Ambulance", "ApolloRescue.module.algorithm.ApolloPathPlanning");
			this.clustering = moduleManager.getModule("TestSearch.Clustering.Ambulance", "ApolloRescue.module.algorithm.ApolloKMeans");
		} else if (agentURN == FIRE_BRIGADE) {
			this.pathPlanning = moduleManager.getModule("TestSearch.PathPlanning.Fire", "ApolloRescue.module.algorithm.ApolloPathPlanning");
			this.clustering = moduleManager.getModule("TestSearch.Clustering.Fire", "ApolloRescue.module.algorithm.ApolloKMeans");
		} else if (agentURN == POLICE_FORCE) {
			this.pathPlanning = moduleManager.getModule("TestSearch.PathPlanning.Police", "ApolloRescue.module.algorithm.ApolloPathPlanning");
			this.clustering = moduleManager.getModule("TestSearch.Clustering.Police", "ApolloRescue.module.algorithm.ApolloKMeans");
		}
